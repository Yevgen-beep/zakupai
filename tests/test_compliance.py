...
def test_single_source_list_contains_bank_deposits():
    ...
    assert (
        "bank_deposits" in ComplianceSettings.SINGLE_SOURCE_LIST
...
def test_single_source_list_contains_credit_ratings():
    ...
    assert (
        "credit_ratings" in ComplianceSettings.SINGLE_SOURCE_LIST
...
def test_single_source_list_contains_scientific_research():
    ...
    assert (
        "scientific_research" in ComplianceSettings.SINGLE_SOURCE_LIST
...
def test_single_source_list_contains_national_bank_services():
    ...
    assert (
        "national_bank_services" in ComplianceSettings.SINGLE_SOURCE_LIST
...
def test_anti_dumping_threshold():
    ...
    assert (
        ComplianceSettings.ANTI_DEMPING_THRESHOLD == 0.15
...
def test_complaint_deadline_days():
    ...
    assert (
        ComplianceSettings.COMPLAINT_DEADLINE_DAYS == 3
...
def test_excluded_procurements_contains_military_goods():
    ...
    assert (
        "military_goods" in ComplianceSettings.EXCLUDED_PROCUREMENTS
...
def test_excluded_procurements_contains_labor_contracts():
    ...
    assert (
        "labor_contracts" in ComplianceSettings.EXCLUDED_PROCUREMENTS
...
def test_excluded_procurements_contains_international_projects():
    ...
    assert (
        "international_projects" in ComplianceSettings.EXCLUDED_PROCUREMENTS
...
def test_affil_check_enabled():
    ...
    assert (
        ComplianceSettings.AFFIL_CHECK_ENABLED is True
...
def test_single_source_enabled():
    ...
    assert (
        ComplianceSettings.SINGLE_SOURCE_ENABLED is True
...
def test_affil_ban_in_single_source():
    ...
    assert (
        ComplianceSettings.AFFIL_BAN_IN_SINGLE_SOURCE is True
...
def test_rating_agency_threshold():
    ...
    assert (
        ComplianceSettings.RATING_AGENCY_THRESHOLD == "A-"
...
def test_cancel_procedure_days():
    ...
    assert (
        ComplianceSettings.CANCEL_PROCEDURE_DAYS == 5
...
def test_turnkey_contest_enabled():
    ...
    assert (
        ComplianceSettings.TURNKEY_CONTEST_ENABLED is True
